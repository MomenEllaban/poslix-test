...
const PackageItemsModal = (props: any) => {
  const { filterdItems, packItems, isOpenDialog, setIsOpenDialog } = props;
  return (
    <>
      <Dialog
        open={isOpenDialog}
        ...
        <DialogTitle className="poslix-modal-title text-primary">Package Content</DialogTitle>
