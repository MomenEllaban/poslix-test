      ...
      >
        <Box sx={style}>
          <div style={leftColumnStyle}>
            ...
            <div>
              <div style={listItemStyle}>
                <span style={listItemLabelStyle}>Transfer ID:</span>
                <span>{transfer?.id}</span>
              </div>
              <div style={listItemStyle}>
                <span style={listItemLabelStyle}>From:</span>
                <span>{transfer?.location_from_name}</span>
              </div>
              <div style={listItemStyle}>
                <span style={listItemLabelStyle}>To:</span>
                <span>{transfer?.location_to_name}</span>
              </div>
              <div style={listItemStyle}>
                <span style={listItemLabelStyle}>Status:</span>
                <span>{transfer?.status}</span>
              </div>
              <div style={listItemStyle}>
                <span style={listItemLabelStyle}>Reference Number:</span>
                <span>{transfer?.ref_no}</span>
              </div>
              <div style={listItemStyle}>
                <span style={listItemLabelStyle}>Total Price:</span>
          ...
          <div style={rightColumnStyle}>
            ...
            <ul>
              {transfer?.products?.map((prod) => (
                <li key={prod?.id} style={listItemStyle}>
                  <span>{prod?.name}</span>
                  <span>Qty: {+prod?.pivot?.qty}</span>
                </li>
              ))}
            </ul>
            <div style={listItemStyle}>
              <span style={labelStyle}>Stocks:</span>
            </div>
            <ul>
              {transfer?.stocks?.map((stock) => (
                <li key={stock?.id} style={listItemStyle}>
                  <span>Qty Received: {+stock?.qty_received}</span>
                  <span>Qty Sold: {+stock?.qty_sold}</span>
                </li>
              ))}
            </ul>
            <div style={listItemStyle}>
              <span style={listItemLabelStyle}>Exchange Rate:</span>
              <span>{+transfer?.exchange_rate}</span>
            </div>
            <div style={listItemStyle}>
              <span style={listItemLabelStyle}>Created By:</span>
              <span>
                {
            ...
            <div style={listItemStyle}>
              <span style={listItemLabelStyle}>Created At:</span>
