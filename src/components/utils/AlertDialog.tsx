        ...
        <>
            ...
            >
                ...
                <Modal.Footer className='d-flex '>
                    <Button className='p-2' style={{ background: '#ffffff', color: '#000', border: 'none' }} onClick={handleClose}>   {t('alert_dialog.dismiss')}   </Button>
                    <Button className='p-2' style={{ background: '#e75050', color: '#ffffff' }} onClick={actionHandle}> {url==='transfer'? t('alert_dialog.cancel_transefer') : t('alert_dialog.delete')} </Button>
                </Modal.Footer>
            </Modal>
        </>
    )
